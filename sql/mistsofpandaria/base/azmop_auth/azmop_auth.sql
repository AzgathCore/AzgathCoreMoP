...
MySQL - 10.5.8-MariaDB : Database - azmop_auth
*********************************************************************
*/
...
(1,'AzgathCore','AzgathCore 5.4.8','127.0.0.1',8085,0,2,10,0,0,18414,32,0,1,'azmop_chars','azmop_world','azmop_archive',0,0,80,'IGNORE','IGNORE','IGNORE','IGNORE',0,'0','0',1,0,0,0);

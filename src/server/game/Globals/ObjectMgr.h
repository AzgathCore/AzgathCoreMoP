...
#define MIN_AZGATH_STRING_ID           1                    // 'azgath_string'
#define MAX_AZGATH_STRING_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_AZGATH_STRING_ID // 'db_script_string'
...
class ObjectMgr
{
    ...
    public:
        ...
        */
        ...
        bool LoadTrinityStrings() { return LoadTrinityStrings("azgath_string", MIN_AZGATH_STRING_ID, MAX_AZGATH_STRING_ID); }
